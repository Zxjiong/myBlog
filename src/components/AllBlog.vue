<template>
  <div class="blogBox">
    <div class="blogMainContent">
      <ul class="clearfix">
        <li v-for="(blog,index) in filterBlogs" @click="goToBlogDetail(blog)" :key="index">
          <div class="blogHead clearfix">
            <img :src="'./../static/'+blog.authorPic" alt="" class="authorHead" v-rainbow="'active'">
      ...
      <div class="controlBar">
        <span v-for="(controlBtn,index) in controlArr" :key="index" @click="pagination(index)" class="controlBtn" :class="{'activeControl':curControlIndex==index}">{{controlBtn}}</span>
      </div>
    ...
    <div class="asideMenu">
      <div class="filterMenu" :class="showAsideMenu?'filterAnimation1':'filterAnimation2'">
        <ul>
          <li v-for="(tags,index) in filterMenuArr" :key="index" @click="filterBlog(tags,index)" :class="{'activeFilter':curFilterIndex==index}">{{tags}}</li>
        </ul>
      </div>
    ...
    export default {
        ...
        data(){
          return{
            controlArr:['上一页','下一页'],
            curControlIndex:0,
            filterMenuArr:['All','HTML','CSS','Javascript','Vue','MongoDB'],
            curFilterIndex:0,
            showAsideMenu:false,
            blogList:[],
            page:1,
